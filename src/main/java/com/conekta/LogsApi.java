...
public class LogsApi {
   ...
   */
  public LogResponseForRequest getLogById(@javax.annotation.Nonnull String id, @javax.annotation.Nullable String acceptLanguage, @javax.annotation.Nullable String xChildCompanyId) throws ApiException {
   ...
   */
  public ApiResponse<LogResponseForRequest> getLogByIdWithHttpInfo(@javax.annotation.Nonnull String id, @javax.annotation.Nullable String acceptLanguage, @javax.annotation.Nullable String xChildCompanyId) throws ApiException {
