...
if (xChildCompanyId != null)
    ...
    return apiClient.invokeAPI("TransactionsApi.getTransaction", localVarPath, "GET", localVarQueryParams, localVarPostBody,
...
if (xChildCompanyId != null)
    ...
    return apiClient.invokeAPI("TransactionsApi.getTransactions", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
}
