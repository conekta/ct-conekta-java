        ...
        public CreateCustomerPaymentMethodsResponse deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            switch (discriminatorValue) {
                ...
                case "payment_method_spei_recurrent":
                    ...
                    return newCreateCustomerPaymentMethodsResponse;
                default:
                    log.log(Level.WARNING, String.format("Failed to lookup discriminator value `%s` for CreateCustomerPaymentMethodsResponse. Possible values: card cash oxxo_recurrent spei_recurrent payment_method_card_response payment_method_cash_response payment_method_spei_recurrent", discriminatorValue));
            }
