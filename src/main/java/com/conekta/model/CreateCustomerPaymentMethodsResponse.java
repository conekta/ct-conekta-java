...
public class CreateCustomerPaymentMethodsResponse extends AbstractOpenApiSchema {
        ...
        public CreateCustomerPaymentMethodsResponse deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            switch (discriminatorValue) {
                ...
                case "spei_recurrent":
                    ...
                    return newCreateCustomerPaymentMethodsResponse;
                default:
                    log.log(Level.WARNING, String.format(java.util.Locale.ROOT, "Failed to lookup discriminator value `%s` for CreateCustomerPaymentMethodsResponse. Possible values: card cash cash_recurrent spei_recurrent", discriminatorValue));
            }
            ...
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for CreateCustomerPaymentMethodsResponse: %d classes match result, expected 1", match));
        }
    ...
    public CreateCustomerPaymentMethodsResponse(PaymentMethodSpeiRecurrentResponse o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
