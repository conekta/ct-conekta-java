...
public class CustomerPaymentMethodsData extends AbstractOpenApiSchema {
        ...
        public CustomerPaymentMethodsData deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            switch (discriminatorValue) {
                ...
                case "spei_recurrent":
                    ...
                    return newCustomerPaymentMethodsData;
                default:
                    log.log(Level.WARNING, String.format(java.util.Locale.ROOT, "Failed to lookup discriminator value `%s` for CustomerPaymentMethodsData. Possible values: card cash cash_recurrent spei_recurrent", discriminatorValue));
            }
            ...
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for CustomerPaymentMethodsData: %d classes match result, expected 1", match));
        }
    ...
    public CustomerPaymentMethodsData(PaymentMethodSpeiRecurrentResponse o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
