...
public class ChargesOrderResponse {
  ...
  public ChargesOrderResponse nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public ChargesOrderResponse previousPageUrl(@javax.annotation.Nullable String previousPageUrl) {
  ...
  public ChargesOrderResponse data(@javax.annotation.Nullable List<ChargeResponse> data) {
    this.data = data;
    return this;
  }
