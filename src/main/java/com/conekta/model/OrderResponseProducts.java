...
public class OrderResponseProducts {
  ...
  public OrderResponseProducts hasMore(@javax.annotation.Nonnull Boolean hasMore) {
  ...
  public OrderResponseProducts _object(@javax.annotation.Nonnull String _object) {
  ...
  public OrderResponseProducts nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public OrderResponseProducts previousPageUrl(@javax.annotation.Nullable String previousPageUrl) {
  ...
  public OrderResponseProducts data(@javax.annotation.Nullable List<ProductDataResponse> data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<ProductDataResponse> data) {
    this.data = data;
  }
