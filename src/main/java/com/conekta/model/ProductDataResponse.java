...
public class ProductDataResponse {
  ...
  public ProductDataResponse antifraudInfo(@javax.annotation.Nullable Map<String, Object> antifraudInfo) {
  ...
  public ProductDataResponse brand(@javax.annotation.Nullable String brand) {
    this.brand = brand;
    return this;
  }
  ...
  public ProductDataResponse description(@javax.annotation.Nullable String description) {
  ...
  public ProductDataResponse name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public ProductDataResponse quantity(@javax.annotation.Nonnull Integer quantity) {
  ...
  public ProductDataResponse sku(@javax.annotation.Nullable String sku) {
    this.sku = sku;
    return this;
  }
  ...
  public ProductDataResponse tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public ProductDataResponse unitPrice(@javax.annotation.Nonnull Integer unitPrice) {
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_UNIT_PRICE, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  public ProductDataResponse id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ProductDataResponse _object(@javax.annotation.Nullable String _object) {
  ...
  public ProductDataResponse parentId(@javax.annotation.Nullable String parentId) {
