...
@JsonPropertyOrder({
  ...
  ChargesDataResponse.JSON_PROPERTY_CHARGEBACK,
...
public class ChargesDataResponse {
  ...
  public ChargesDataResponse amount(@javax.annotation.Nonnull Integer amount) {
    this.amount = amount;
    return this;
  }
  ...
  public ChargesDataResponse channel(@javax.annotation.Nullable ChargeResponseChannel channel) {
  ...
  public ChargesDataResponse createdAt(@javax.annotation.Nonnull Long createdAt) {
  ...
  public ChargesDataResponse currency(@javax.annotation.Nonnull String currency) {
  ...
  public ChargesDataResponse customerId(@javax.annotation.Nullable String customerId) {
  ...
  public ChargesDataResponse description(@javax.annotation.Nullable String description) {
  ...
  public ChargesDataResponse deviceFingerprint(@javax.annotation.Nullable String deviceFingerprint) {
  ...
  public ChargesDataResponse failureCode(@javax.annotation.Nullable String failureCode) {
  ...
  public ChargesDataResponse failureMessage(@javax.annotation.Nullable String failureMessage) {
  ...
  public ChargesDataResponse id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public ChargesDataResponse livemode(@javax.annotation.Nonnull Boolean livemode) {
  ...
  public ChargesDataResponse _object(@javax.annotation.Nonnull String _object) {
  ...
  public ChargesDataResponse orderId(@javax.annotation.Nonnull String orderId) {
  ...
  public ChargesDataResponse paidAt(@javax.annotation.Nullable Long paidAt) {
    this.paidAt = paidAt;
    return this;
  }
  ...
  public ChargesDataResponse paymentMethod(@javax.annotation.Nullable ChargeResponsePaymentMethod paymentMethod) {
  ...
  public ChargesDataResponse referenceId(@javax.annotation.Nullable String referenceId) {
  ...
  public ChargesDataResponse refunds(@javax.annotation.Nullable ChargeResponseRefunds refunds) {
  ...
  public ChargesDataResponse chargeback(@javax.annotation.Nullable ChargebackResponse chargeback) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_CHARGEBACK, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_CHARGEBACK, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setChargeback(@javax.annotation.Nullable ChargebackResponse chargeback) {
    this.chargeback = chargeback;
  }


  public ChargesDataResponse status(@javax.annotation.Nonnull String status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, chargesDataResponse.amount) &&
        ...
        Objects.equals(this.chargeback, chargesDataResponse.chargeback) &&
