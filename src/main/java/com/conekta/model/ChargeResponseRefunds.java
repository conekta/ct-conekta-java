...
public class ChargeResponseRefunds {
  ...
  public ChargeResponseRefunds hasMore(@javax.annotation.Nonnull Boolean hasMore) {
  ...
  public ChargeResponseRefunds _object(@javax.annotation.Nonnull String _object) {
  ...
  public ChargeResponseRefunds nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public ChargeResponseRefunds previousPageUrl(@javax.annotation.Nullable String previousPageUrl) {
  ...
  public ChargeResponseRefunds data(@javax.annotation.Nullable List<ChargeResponseRefundsData> data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<ChargeResponseRefundsData> data) {
    this.data = data;
  }
