...
@JsonPropertyOrder({
  ...
  OrderResponseCheckout.JSON_PROPERTY_EXCLUDED_PAYMENT_METHODS,
...
public class OrderResponseCheckout {
  ...
  public OrderResponseCheckout excludedPaymentMethods(@javax.annotation.Nullable List<ExcludedPaymentMethodsEnum> excludedPaymentMethods) {
    this.excludedPaymentMethods = excludedPaymentMethods;
    return this;
  }

  public OrderResponseCheckout addExcludedPaymentMethodsItem(ExcludedPaymentMethodsEnum excludedPaymentMethodsItem) {
  ...
  public OrderResponseCheckout livemode(@javax.annotation.Nonnull Boolean livemode) {
  ...
  public OrderResponseCheckout successUrl(@javax.annotation.Nullable URI successUrl) {
  ...
  public OrderResponseCheckout url(@javax.annotation.Nullable URI url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowedPaymentMethods, orderResponseCheckout.allowedPaymentMethods) &&
        Objects.equals(this.excludedPaymentMethods, orderResponseCheckout.excludedPaymentMethods) &&
