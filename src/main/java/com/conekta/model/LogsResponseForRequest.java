 ...
 */
@JsonPropertyOrder({
  LogsResponseForRequest.JSON_PROPERTY_HAS_MORE,
  LogsResponseForRequest.JSON_PROPERTY_OBJECT,
  LogsResponseForRequest.JSON_PROPERTY_NEXT_PAGE_URL,
  LogsResponseForRequest.JSON_PROPERTY_PREVIOUS_PAGE_URL,
...
public class LogsResponseForRequest {
  ...
  @javax.annotation.Nullable
  private List<LogsResponseData> data = new ArrayList<>();

  public LogsResponseForRequest() { 
  }
  ...
  public LogsResponseForRequest nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public LogsResponseForRequest previousPageUrl(@javax.annotation.Nullable String previousPageUrl) {
  ...
  public LogsResponseForRequest data(@javax.annotation.Nullable List<LogsResponseData> data) {
    this.data = data;
    return this;
  }

  public LogsResponseForRequest addDataItem(LogsResponseData dataItem) {
    if (this.data == null) {
  ...
  /**
   * Return true if this logs_response_for_request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    LogsResponseForRequest logsResponseForRequest = (LogsResponseForRequest) o;
    return Objects.equals(this.hasMore, logsResponseForRequest.hasMore) &&
        Objects.equals(this._object, logsResponseForRequest._object) &&
        Objects.equals(this.nextPageUrl, logsResponseForRequest.nextPageUrl) &&
        Objects.equals(this.previousPageUrl, logsResponseForRequest.previousPageUrl) &&
        Objects.equals(this.data, logsResponseForRequest.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class LogsResponseForRequest {\n");
