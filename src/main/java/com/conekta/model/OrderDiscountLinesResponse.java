...
@JsonPropertyOrder({
  ...
  OrderDiscountLinesResponse.JSON_PROPERTY_NEXT_PAGE_URL,
  OrderDiscountLinesResponse.JSON_PROPERTY_PREVIOUS_PAGE_URL,
...
public class OrderDiscountLinesResponse {
  ...
  public OrderDiscountLinesResponse hasMore(@javax.annotation.Nonnull Boolean hasMore) {
  ...
  public OrderDiscountLinesResponse _object(@javax.annotation.Nonnull String _object) {
  ...
  public OrderDiscountLinesResponse nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public OrderDiscountLinesResponse previousPageUrl(@javax.annotation.Nullable String previousPageUrl) {
  ...
  public OrderDiscountLinesResponse data(@javax.annotation.Nullable List<DiscountLinesDataResponse> data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<DiscountLinesDataResponse> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.hasMore, orderDiscountLinesResponse.hasMore) &&
        ...
        Objects.equals(this.nextPageUrl, orderDiscountLinesResponse.nextPageUrl) &&
        Objects.equals(this.previousPageUrl, orderDiscountLinesResponse.previousPageUrl) &&
