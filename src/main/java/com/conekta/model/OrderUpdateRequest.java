...
public class OrderUpdateRequest {
  ...
  public OrderUpdateRequest charges(@javax.annotation.Nullable List<ChargeRequest> charges) {
  ...
  public OrderUpdateRequest checkout(@javax.annotation.Nullable CheckoutRequest checkout) {
  ...
  public OrderUpdateRequest currency(@javax.annotation.Nullable String currency) {
  ...
  public OrderUpdateRequest customerInfo(@javax.annotation.Nullable OrderUpdateRequestCustomerInfo customerInfo) {
  ...
  @JsonProperty(JSON_PROPERTY_CUSTOMER_INFO)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCustomerInfo(@javax.annotation.Nullable OrderUpdateRequestCustomerInfo customerInfo) {
    this.customerInfo = customerInfo;
  }


  public OrderUpdateRequest discountLines(@javax.annotation.Nullable List<OrderDiscountLinesRequest> discountLines) {
  ...
  public OrderUpdateRequest fiscalEntity(@javax.annotation.Nullable OrderUpdateFiscalEntityRequest fiscalEntity) {
  ...
  public OrderUpdateRequest lineItems(@javax.annotation.Nullable List<Product> lineItems) {
  ...
  public OrderUpdateRequest metadata(@javax.annotation.Nullable Map<String, String> metadata) {
  ...
  public OrderUpdateRequest preAuthorize(@javax.annotation.Nullable Boolean preAuthorize) {
  ...
  public OrderUpdateRequest shippingContact(@javax.annotation.Nullable CustomerShippingContacts shippingContact) {
  ...
  public OrderUpdateRequest shippingLines(@javax.annotation.Nullable List<ShippingRequest> shippingLines) {
  ...
  public OrderUpdateRequest taxLines(@javax.annotation.Nullable List<OrderTaxRequest> taxLines) {
