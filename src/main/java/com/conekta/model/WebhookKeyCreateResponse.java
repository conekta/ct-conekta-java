...
@JsonTypeName("webhook_key_create_response")
...
public class WebhookKeyCreateResponse {
  ...
  public WebhookKeyCreateResponse active(@javax.annotation.Nullable Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public WebhookKeyCreateResponse createdAt(@javax.annotation.Nullable Long createdAt) {
  ...
  public WebhookKeyCreateResponse id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public WebhookKeyCreateResponse livemode(@javax.annotation.Nullable Boolean livemode) {
  ...
  public WebhookKeyCreateResponse _object(@javax.annotation.Nullable String _object) {
  ...
  public WebhookKeyCreateResponse publicKey(@javax.annotation.Nullable String publicKey) {
  ...
  /**
   * Return true if this webhook_key_create_response object is equal to o.
   */
  @Override
