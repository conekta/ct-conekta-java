...
public class GetPaymentMethodResponse {
  ...
  @javax.annotation.Nullable
  private List<GetCustomerPaymentMethodDataResponse> data = new ArrayList<>();

  public GetPaymentMethodResponse() { 
  }

  public GetPaymentMethodResponse hasMore(@javax.annotation.Nonnull Boolean hasMore) {
  ...
  public GetPaymentMethodResponse _object(@javax.annotation.Nonnull String _object) {
  ...
  public GetPaymentMethodResponse nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public GetPaymentMethodResponse previousPageUrl(@javax.annotation.Nullable String previousPageUrl) {
  ...
  public GetPaymentMethodResponse data(@javax.annotation.Nullable List<GetCustomerPaymentMethodDataResponse> data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<GetCustomerPaymentMethodDataResponse> data) {
    this.data = data;
  }
