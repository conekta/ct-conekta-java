...
public class UpdateCustomerPaymentMethodsResponse extends AbstractOpenApiSchema {
    ...
    public UpdateCustomerPaymentMethodsResponse(PaymentMethodCashRecurrentResponse o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public UpdateCustomerPaymentMethodsResponse(PaymentMethodSpeiRecurrentResponse o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
