...
public class CustomersResponse {
  ...
  public CustomersResponse hasMore(@javax.annotation.Nonnull Boolean hasMore) {
  ...
  public CustomersResponse _object(@javax.annotation.Nonnull String _object) {
  ...
  public CustomersResponse nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public CustomersResponse previousPageUrl(@javax.annotation.Nullable String previousPageUrl) {
  ...
  public CustomersResponse data(@javax.annotation.Nullable List<CustomerResponse> data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<CustomerResponse> data) {
    this.data = data;
  }
