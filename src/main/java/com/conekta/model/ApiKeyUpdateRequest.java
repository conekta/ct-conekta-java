...
public class ApiKeyUpdateRequest {
  ...
  public ApiKeyUpdateRequest active(@javax.annotation.Nullable Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public ApiKeyUpdateRequest description(@javax.annotation.Nullable String description) {
