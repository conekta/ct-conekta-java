...
public class Customer {
  ...
  public Customer antifraudInfo(@javax.annotation.Nullable CustomerAntifraudInfo antifraudInfo) {
  ...
  @JsonProperty(JSON_PROPERTY_ANTIFRAUD_INFO)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAntifraudInfo(@javax.annotation.Nullable CustomerAntifraudInfo antifraudInfo) {
    this.antifraudInfo = antifraudInfo;
  }


  public Customer corporate(@javax.annotation.Nullable Boolean corporate) {
  ...
  public Customer customReference(@javax.annotation.Nullable String customReference) {
  ...
  public Customer dateOfBirth(@javax.annotation.Nullable String dateOfBirth) {
  ...
  public Customer defaultPaymentSourceId(@javax.annotation.Nullable String defaultPaymentSourceId) {
  ...
  public Customer defaultShippingContactId(@javax.annotation.Nullable String defaultShippingContactId) {
  ...
  public Customer fiscalEntities(@javax.annotation.Nullable List<CustomerFiscalEntitiesRequest> fiscalEntities) {
  ...
  public Customer metadata(@javax.annotation.Nullable Map<String, Object> metadata) {
  ...
  public Customer nationalId(@javax.annotation.Nullable String nationalId) {
  ...
  public Customer paymentSources(@javax.annotation.Nullable List<CustomerPaymentMethodsRequest> paymentSources) {
  ...
  public Customer phone(@javax.annotation.Nonnull String phone) {
    this.phone = phone;
    return this;
  }
  ...
  public Customer planId(@javax.annotation.Nullable String planId) {
    this.planId = planId;
    return this;
  }
  ...
  public Customer shippingContacts(@javax.annotation.Nullable List<CustomerShippingContacts> shippingContacts) {
  ...
  public Customer subscription(@javax.annotation.Nullable SubscriptionRequest subscription) {
