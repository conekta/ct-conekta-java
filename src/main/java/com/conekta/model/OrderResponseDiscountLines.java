...
@JsonPropertyOrder({
  ...
  OrderResponseDiscountLines.JSON_PROPERTY_NEXT_PAGE_URL,
  OrderResponseDiscountLines.JSON_PROPERTY_PREVIOUS_PAGE_URL,
...
public class OrderResponseDiscountLines {
  ...
  public OrderResponseDiscountLines hasMore(@javax.annotation.Nonnull Boolean hasMore) {
  ...
  public OrderResponseDiscountLines _object(@javax.annotation.Nonnull String _object) {
  ...
  public OrderResponseDiscountLines nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public OrderResponseDiscountLines previousPageUrl(@javax.annotation.Nullable String previousPageUrl) {
  ...
  public OrderResponseDiscountLines data(@javax.annotation.Nullable List<DiscountLinesDataResponse> data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.hasMore, orderResponseDiscountLines.hasMore) &&
        ...
        Objects.equals(this.nextPageUrl, orderResponseDiscountLines.nextPageUrl) &&
        Objects.equals(this.previousPageUrl, orderResponseDiscountLines.previousPageUrl) &&
