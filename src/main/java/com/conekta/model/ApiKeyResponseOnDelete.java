...
public class ApiKeyResponseOnDelete {
  ...
  public ApiKeyResponseOnDelete active(@javax.annotation.Nullable Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public ApiKeyResponseOnDelete createdAt(@javax.annotation.Nullable Long createdAt) {
  ...
  public ApiKeyResponseOnDelete description(@javax.annotation.Nullable String description) {
  ...
  public ApiKeyResponseOnDelete livemode(@javax.annotation.Nullable Boolean livemode) {
  ...
  public ApiKeyResponseOnDelete prefix(@javax.annotation.Nullable String prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public ApiKeyResponseOnDelete id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ApiKeyResponseOnDelete _object(@javax.annotation.Nullable String _object) {
  ...
  public ApiKeyResponseOnDelete deleted(@javax.annotation.Nullable Boolean deleted) {
  ...
  public ApiKeyResponseOnDelete role(@javax.annotation.Nullable String role) {
    this.role = role;
    return this;
  }
