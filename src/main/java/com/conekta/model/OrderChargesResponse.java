...
public class OrderChargesResponse {
  ...
  public OrderChargesResponse nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public OrderChargesResponse previousPageUrl(@javax.annotation.Nullable String previousPageUrl) {
