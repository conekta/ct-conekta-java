...
public class GetOrderDiscountLinesResponse {
  ...
  public GetOrderDiscountLinesResponse hasMore(@javax.annotation.Nonnull Boolean hasMore) {
  ...
  public GetOrderDiscountLinesResponse _object(@javax.annotation.Nonnull String _object) {
  ...
  public GetOrderDiscountLinesResponse nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public GetOrderDiscountLinesResponse previousPageUrl(@javax.annotation.Nullable String previousPageUrl) {
  ...
  public GetOrderDiscountLinesResponse data(@javax.annotation.Nullable List<DiscountLinesResponse> data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<DiscountLinesResponse> data) {
    this.data = data;
  }
