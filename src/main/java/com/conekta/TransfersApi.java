...
public class TransfersApi {
   ...
   */
  public TransferResponse getTransfer(@javax.annotation.Nonnull String id, @javax.annotation.Nullable String acceptLanguage, @javax.annotation.Nullable String xChildCompanyId) throws ApiException {
   ...
   */
  public ApiResponse<TransferResponse> getTransferWithHttpInfo(@javax.annotation.Nonnull String id, @javax.annotation.Nullable String acceptLanguage, @javax.annotation.Nullable String xChildCompanyId) throws ApiException {
    ...
    return apiClient.invokeAPI("TransfersApi.getTransfer", localVarPath, "GET", new ArrayList<>(), null,
   ...
   */
  public ApiResponse<GetTransfersResponse> getTransfersWithHttpInfo(@javax.annotation.Nullable String acceptLanguage, @javax.annotation.Nullable String xChildCompanyId, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable String search, @javax.annotation.Nullable String next, @javax.annotation.Nullable String previous) throws ApiException {
    // Query parameters
    ...
    return apiClient.invokeAPI("TransfersApi.getTransfers", "/transfers", "GET", localVarQueryParams, null,
                               localVarHeaderParams, new LinkedHashMap<>(), new LinkedHashMap<>(), localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
}
